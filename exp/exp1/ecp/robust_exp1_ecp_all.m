% Script to run Experiment 1 with the ECP algorithm
...
if setting == 1
    prevfile = load('exp/exp1/rst/ecp_set2.mat');
elseif setting == 2
    prevfile = load('exp/exp1/rst/ecp_set3.mat');
elseif setting == 3
    prevfile = load('exp/exp1/rst/ecp_set4.mat');
else
    clear prevfile;
end
...
save(sprintf('exp/exp1/rst/ecp_set%d.mat', setting));
