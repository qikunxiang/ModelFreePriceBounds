...
% of LP problems and MILP problems solved in Experiment 1
...
for setting = 1:4
d1 = load(sprintf('exp/exp1/rst/ecp_set%d.mat', setting));
d2 = load(sprintf('exp/exp1/rst/accp_set%d.mat', setting));
