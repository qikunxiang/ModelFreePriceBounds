...
% Experiment 1 with the ACCP algorithm

load('exp/exp1/rst/accp_set1.mat');

id = 36;

for lu = 1:2

x_opt = outputs{id, lu}.x_opt;
measure_opt = max(outputs{id, lu}.measure_opt, 0);
...
if lu == 1
    sgtitle('ACCP - Upper Bound', 'FontWeight', 'bold', 'FontSize', 12);
else
    sgtitle('ACCP - Lower Bound', 'FontWeight', 'bold', 'FontSize', 12);
end
