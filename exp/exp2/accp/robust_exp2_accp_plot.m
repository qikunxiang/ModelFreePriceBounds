% Script to plot the result of Experiment 2 with the ACCP algorithm

load('exp/exp2/exp2.mat');
dat1 = load('exp/exp2/rst/accp_set1.mat');
dat2 = load('exp/exp2/rst/accp_set2.mat');
dat3 = load('exp/exp2/rst/accp_set3.mat');
dat4 = load('exp/exp2/rst/accp_set4.mat');
